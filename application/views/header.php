...
<div>
    ...
    <input id="music_radio" class="button" style="width: 20px;"
        ...
        onclick="if(this.checked) { $('#music_types').css('display','inline'); $('#video_types').css('display','none'); $('#document_types').css('display','none'); $('#archive_types').css('display','none'); $('#android_types').css('display','inline'); $('#image_types').css('display','none'); $('#torrent_types').css('display','none'); } $('#searchbox').focus();" />
    Music
  
    <input id="document_radio" class="button" style="width: 20px;" type="radio"
        name="searchType" value="document"
        onclick="if(this.checked) { $('#document_types').css('display','inline'); $('#music_types').css('display','none'); $('#video_types').css('display','none'); $('#archive_types').css('display','none'); $('#android_types').css('display','inline'); $('#image_types').css('display','none'); $('#torrent_types').css('display','none');} $('#searchbox').focus();" />

    Document

    <input id="archive_radio" class="button" style="width: 20px;" type="radio"
        name="searchType" value="archive"
        onclick="if(this.checked) { $('#archive_types').css('display','inline'); $('#music_types').css('display','none'); $('#document_types').css('display','none'); $('#video_types').css('display','none'); $('#android_types').css('display','inline'); $('#image_types').css('display','none'); $('#torrent_types').css('display','none'); } $('#searchbox').focus();" />
   Archive

    <input id="video_radio" class="button" style="width: 20px;" type="radio"
        name="searchType" value="video"
        onclick="if(this.checked) { $('#video_types').css('display','inline'); $('#music_types').css('display','none'); $('#document_types').css('display','none'); $('#archive_types').css('display','none'); $('#android_types').css('display','inline'); $('#image_types').css('display','none'); $('#torrent_types').css('display','none'); } $('#searchbox').focus();" />
   Video

    <input id="image_radio" class="button" style="width: 20px;" type="radio"
        name="searchType" value="image"
        onclick="if(this.checked) { $('#video_types').css('display','none'); $('#music_types').css('display','none'); $('#document_types').css('display','none'); $('#archive_types').css('display','none'); $('#image_types').css('display','inline'); $('#torrent_types').css('display','none'); $('#android_types').css('display','inline'); } $('#searchbox').focus();" />
   Image
   ...
   <input id="torrent_radio" class="button" style="width: 20px;" type="radio"
        ...
        onclick="if(this.checked) { $('#torrent_types').css('display','inline'); $('#music_types').css('display','none'); $('#document_types').css('display','none'); $('#video_types').css('display','none'); } $('#searchbox').focus();" />
   Torrent

   </div>
   </div>
</div>
<div id="search_div" style="margin-top: 20px; position: absolute;">
	<div style="margin-left: 150px; clear: all;">
		<div>
			<input id="searchbox" type="text" name="keyword" value="" style="border-collapse: collapse; border: 1px solid #009a9a; color: #565656; background: transparent;" value=""/>
...
<?php
	...
	{
?>
			<div style="float: left; margin-left: 5px; margin-top: 5px; color: #676767; text-align: center;"> 
				<div id="music_types" style="display: none;"><em>mp3,wma,ogg,flac,au</em></div>
	...
	<div id="coinUrlAd" style="clear: both; margin-left: auto; margin-right: auto; text-align: center; margin-top: 15px; margin-bottom: 3px;"><iframe scrolling="no" style="border: 0; width: 468px; height: 60px;" src="http://coinurl.com/get.php?id=17890"></iframe></div>
<?php
	}
	else
	{
?>
	<div id="coinUrlAd" style="margin-left: auto; margin-right: auto; text-align: center; margin-top: 25px; margin-bottom: 3px;"><iframe scrolling="no" style="border: 0; width: 468px; height: 60px;" src="http://coinurl.com/get.php?id=17890"></iframe></div>
<?php
	}
?>
</div>
