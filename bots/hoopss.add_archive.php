...
if(!isset($argv[1])) echo "Usage: php add_archieve.php <url> [<limit>]";
else $url = $argv[1];
...
$file_types = "zip|ZIP|rar|RAR|tar|TAR|gz|GZ|bz2|BZ2|z|Z|7z|7Z|iso|ISO|nrg|NRG|mdb|MDB";
...
if($curl_query)
{
	$directories = $get_links->getDirectories($url);
      	$file_links = $get_links->getFilesArchieve($url,$file_types_array,$keyword);
}
