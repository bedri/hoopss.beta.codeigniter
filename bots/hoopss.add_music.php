...
{
	$url = '';
	echo "Usage: php hoopss.add_music.php <url>";
}
else $url = $argv[1];
...
$file_types = "mp3|MP3|wma|WMA|ogg|OGG|flac|FLAC|au|AU";
...
if($curl_query)
{
	...
	//echo "\n Directories \n";
	//print_r($directories);
      	$file_links = $get_links->getFilesMusic($url,$file_types_array,$keyword);
	//echo "\n Files \n";
	//print_r($file_links);
}
